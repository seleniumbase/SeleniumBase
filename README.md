...
Easily run Selenium/WebDriver automation in *[Python](https://www.python.org/)* with [Pytest](https://docs.pytest.org/en/latest/) or [Nose](http://nose.readthedocs.io/en/latest/).
