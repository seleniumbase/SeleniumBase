...
**Automation Platform powered by Python and WebDriver**

(SeleniumBase also [speeds up manual testing with MasterQA](https://github.com/seleniumbase/SeleniumBase/blob/master/seleniumbase/masterqa/ReadMe.md))
