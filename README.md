...
* Easily convert your existing Selenium IDE recordings into SeleniumBase. ([Learn more here.](https://github.com/seleniumbase/SeleniumBase/blob/master/integrations/selenium_ide/ReadMe.md))
