...
sb.click_and_hold(selector, timeout=None, scroll=True, timeframe=2)
sb.drag_and_drop(drag_selector, drop_selector, timeout=None, scroll=True)
sb.go_back()
sb.go_forward()
...
sb.highlight(selector, scroll=True, timeout=None)
sb.focus(selector, timeout=None)
...
sb.fast_keys(selector, text, timeout=None)
sb.press_keys(selector, text, timeout=None)
sb.type(selector, text, timeout=None)
sb.fast_type(selector, text, timeout=None)
...
sb.get_tabs()
sb.get_window()
sb.get_text(selector="body", timeout=None)
sb.get_title()
sb.get_current_url()
sb.get_origin()
...
sb.hover_element(selector, timeout=None)
sb.hover_and_click(hover_selector, click_selector, timeout=None)
...
sb.wait_for_element_present(selector, timeout=None)
...
element.click_and_hold(timeframe=2)
