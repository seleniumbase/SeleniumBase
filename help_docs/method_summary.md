...
self.fast_type(selector, text, by="css selector", timeout=None)
...
# Duplicates: self.save_as_html_to_logs(name, folder=None)
...
driver.select_option_by_text(dropdown_selector, option)
driver.select_option_by_index(dropdown_selector, option)
driver.select_option_by_value(dropdown_selector, option)
