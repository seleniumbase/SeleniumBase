### Building a browser-based test automation server on the [Google Cloud Platform](https://cloud.google.com/) using [SeleniumBase](https://github.com/seleniumbase/SeleniumBase)
