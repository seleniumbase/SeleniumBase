...
SELENIUM_JAR = "http://selenium-release.storage.googleapis.com/2.48/selenium-server-standalone-2.48.2.jar"
...
def download_selenium():
    ...
    try:
        ...
        raise Exception("Error while downloading Selenium Server. Details: "+details)
