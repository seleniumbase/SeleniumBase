...
class MD:
    ...
    md["click_link"][4] = "fare_clic_sul_testo_del_collegamento"
    md["click_link"][5] = "リンクテキストをクリックします"
    md["click_link"][6] = "링크_텍스트를_클릭합니다"
    md["click_link"][7] = "clique_no_texto_do_link"
    md["click_link"][8] = "нажмите_на_ссылку"
    md["click_link"][9] = "haga_clic_en_el_texto_del_enlace"
